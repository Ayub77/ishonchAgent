...
import 'package:agent/widgets/windowOrderReport.dart';
...
class _OrderReportState extends State<OrderReport> {
  ...
  final _controller =
      PersistentBottomSheetController; // <------ Instance variable
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              onPressed: () {
                bottomsheet(context, size).then((value){
